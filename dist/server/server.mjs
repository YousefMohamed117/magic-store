var _a, _b, _c, _d;
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, version, unref, nextTick, watchEffect, shallowRef, effectScope, markRaw, toRaw, watch, isReactive, onUnmounted, toRefs, defineAsyncComponent, provide, onErrorCaptured, useSSRContext, Transition, Suspense, withCtx, createVNode, createApp } from "vue";
...
const tailwind = "";
const components = {};
const dist_components_plugin_mjs_KfanmP5AsX = defineNuxtPlugin((nuxtApp) => {
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [{ "rel": "stylesheet", "href": "https://fonts.googleapis.com/icon?family=Material+Icons+Outlined" }, { "rel": "stylesheet", "href": "https://fonts.googleapis.com/css2?family=VT323&display=swap" }], "style": [], "script": [], "noscript": [] };
...
const D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta = {};
const D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta = {};
const _routes = [
  {
    name: (_a = D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta.name) != null ? _a : "cart",
    path: (_b = D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta.path) != null ? _b : "/cart",
    file: "D:/Templates/vue/magicStore/pages/cart.vue",
    children: [],
    meta: D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta,
    alias: (D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta.alias) || [],
    redirect: (D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47cart_46vueMeta.redirect) || void 0,
    component: () => import("./_nuxt/cart.c0f6488d.js").then((m) => m.default || m)
  },
  {
    name: (_c = D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta.name) != null ? _c : "index",
    path: (_d = D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta.path) != null ? _d : "/",
    file: "D:/Templates/vue/magicStore/pages/index.vue",
    children: [],
    meta: D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta,
    alias: (D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta.alias) || [],
    redirect: (D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta == null ? void 0 : D_58_47Templates_47vue_47magicStore_47pages_47index_46vueMeta.redirect) || void 0,
    component: () => import("./_nuxt/index.f894cc8f.js").then((m) => m.default || m)
  }
];
...
const _plugins = [
  dist_components_plugin_mjs_KfanmP5AsX,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.e15e227b.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: () => import("./_nuxt/default.89af1ff3.js").then((m) => m.default || m)
};
